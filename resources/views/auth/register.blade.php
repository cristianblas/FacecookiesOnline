                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="last_name type="las_name" class="form-control" @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required autocomplete="last_name">
                            @error('last_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <option {{ old('status') == 'masculino' ? 'selected' : '' }} value="masculino">Masculino</option>
                                <option {{ old('status') == 'femenino' ? 'selected' : '' }} value="femenino" >Femenino</option>
                                </select>
                                @error('gender')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
